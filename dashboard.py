...
# มูลค่าอาหารเทียบข้าวโพด (= กี่เท่าของข้าวโพด) — ตั้งจากฐาน ME สัตว์ปีก (kcal/kg)
#   ข้าวโพด(ฐาน)~3,300 · มันเส้น~3,150→0.93 · ปลายข้าว~3,350→1.00
#   รำ พลังงานล้วน~2,750→0.83 แต่ CP~14%+ไขมันสูง จึงตั้ง 0.90 (ให้เครดิตโปรตีน/ไขมัน)
#   ที่มา: Feedipedia / งานวิจัย AME สัตว์ปีก · ปรับ slider หน้างานได้ตามคุณภาพจริง
SUB_INGREDIENTS = [("cassava_chip", "มันเส้น", 0.93),
                   ("trm_broken", "ปลายข้าว", 1.00),
                   ("trm_bran", "รำ", 0.90)]
